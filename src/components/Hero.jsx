        ...
        <div className="flex flex-col md:flex-row items-center gap-20 md:gap-60">
          ...
          <div className="max-w-xl space-y-6">
            <h1 className="text-5xl font-bold leading-tight">
              Hi, I'm <br/>
              <span className="text-blue-400">Vinay </span>
              <span className="text-blue-300">Kumar </span>
              <span className="text-blue-200">Mudidana</span>
            </h1>

            <p className="text-xl text-gray-300">
              <button className="
                bg-blue-500 p-2 py-3 rounded-xl text-white
              " >UI/UX & Graphic Designer</button> — 
              <span className="text-purple-400 "> Product-first, Human-centered</span>
            </p>

            {/* <p className="text-gray-400 text-lg">Desginer and Mentor at Purplelane Institute</p> */}
            <p className="text-gray-400 text-lg">
              I design human-centered products & visual systems that balance
